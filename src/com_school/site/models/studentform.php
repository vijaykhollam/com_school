 ...
 * @since  1.6
 */
class SchoolModelStudentForm extends \Joomla\CMS\MVC\Model\FormModel
{
    private $item = null;
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_school.student', 'studentform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    public function delete($pk)
    {
        $user = Factory::getUser();
            ...
            if (empty($pk))
            {
                    $pk = (int) $this->getState('student.id');
            }
