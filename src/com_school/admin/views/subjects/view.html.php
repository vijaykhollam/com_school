...
class SchoolViewSubjects extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// Add submenu
		SchoolHelper::addSubmenu('subjects');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SCHOOL_TITLE_SUBJECTS'), 'stack article');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/subject';
		...
		if (file_exists($formPath))
		{
			if ($this->canCreate)
			{
				...
				JToolbarHelper::custom('subject.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_SCHOOL_SUBJECT_NAME'),
