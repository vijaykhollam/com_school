...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="teacher-form" class="form-validate form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'teacher')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'teacher', JText::_('COM_SCHOOL_TAB_TEACHER', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_SCHOOL_FIELDSET_TEACHER'); ?></legend>
