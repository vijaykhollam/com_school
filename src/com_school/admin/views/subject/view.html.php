...
/**
 * View class for editing student.
 *
 * @package     Tjfields
 * @subpackage  com_tjfields
 * @since       2.2
 */
class SchoolViewSubject extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		if ($isNew)
		{
			$viewTitle = JText::_('COM_SCHOOL_ADD_SUBJECT');
		}
		else
		{
			$viewTitle = JText::_('COM_SCHOOL_EDIT_SUBJECT');
		}
