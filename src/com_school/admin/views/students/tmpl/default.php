...
if ($saveOrder)
{
    ...
    HTMLHelper::_('sortablelist.sortable', 'studentList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo Route::_('index.php?option=com_school&view=students'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="studentList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SCHOOL_STUDENTS_USER_ID', 'a.`user_id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SCHOOL_STUDENTS_NAME', 'a.`name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SCHOOL_STUDENTS_SURNAME', 'a.`surname`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SCHOOL_STUDENTS_EDUCATION', 'a.`education`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SCHOOL_STUDENTS_HOBBIES', 'a.`hobbies`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SCHOOL_STUDENTS_ADDRESS', 'a.`address`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_school&task=student.edit&id='.(int) $item->id); ?>">
